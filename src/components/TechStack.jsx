      ...
      <div className="flex flex-wrap gap-4 text-sm md:text-base">
        ...
        <div className="w-28 md:w-36 px-5 py-2 rounded-3xl border border-1 border-neutral-700">
          <div className="mx-auto flex items-center justify-center gap-2">
            {/* HTML svg */}
            <svg className="h-7 w-7" xmlns="http://www.w3.org/2000/svg" aria-label="HTML5" viewBox="0 0 512 512"><path fill="#e34f26" d="M71 460L30 0h451l-41 460-185 52"/><path fill="#ef652a" d="M256 472l149-41 35-394H256"/><path fill="#ebebeb" d="M256 208h-75l-5-58h80V94H114l15 171h127zm-1 147l-63-17-4-45h-56l7 89 116 32z"/>
        ...
        <div className="w-28 md:w-36 px-5 py-2 rounded-3xl border border-1 border-neutral-700">
          <div className="mx-auto flex items-center justify-center gap-3">
            {/* JS svg */}
            <img src="" alt="" />
            <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" width="2500" height="2500" preserveAspectRatio="xMinYMin meet" viewBox="0 0 256 256">
        ...
        <div className="w-28 md:w-36 px-5 py-2 rounded-3xl border border-1 border-neutral-700">
          <div className="mx-auto flex items-center justify-center gap-2">
            {/* MUI svg */}
            <svg className="h-7 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
        ...
        <div className="w-28 md:w-36 px-5 py-2 rounded-3xl border border-1 border-neutral-700">
          <div className="mx-auto flex items-center justify-center gap-2">
            {/* Vite svg */}
            <img className="h-7 w-7" src="/assets/images/icons/tech/vite-colored.svg" alt="" />
            {/* Vite label */}
            <label className=" justify-self-end text-center font-medium ">
            Vite
            </label>
        ...
        <div className="w-28 md:w-36 px-5 py-2 rounded-3xl border border-1 border-neutral-700">
          <div className="mx-auto flex items-center justify-center gap-2">
            {/* Figma svg */}
            <svg className="h-6 w-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
