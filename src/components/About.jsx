...
export default function About() {
  return (
    /* About section */
    <section id="about" className="pt-12 md:pt-6 px-8">
      {/* About container */}
      <div className="container mx-auto">
        <h2 className="text-2xl md:text-4xl font-bold pb-3 md:pb-6">O mně</h2>
        <p className="md:w-3/5 text-justify text-neutral-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, asperiores perferendis pariatur 
