...
export default function ProjectCardSm({ name, description, img, url }) {
  return (
    <div className="max-w-sm bg-neutral-900 border border-gray-700 rounded-lg shadow ">
      ...
      <div className="p-5">
        <a href="#">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-neutral-100 ">
            {name}
          </h5>
        </a>
        ...
        <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center
         text-white bg-yellow-500 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none
